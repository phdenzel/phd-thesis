...
\affils{
    \chapteraffil[1]{Institute for Computational Science, University of Zurich, CH-8057 Zurich, Switzerland}
    \chapteraffil[2]{Physics Institute, University of Zurich, CH-8057 Zurich, Switzerland}
    \chapteraffil[3]{STAR Institute, Quartier Agora - All\'ee du six Ao$\hat{u}$t, 19c B-4000 Li\`ege, Belgium}
}

\publishedin[Submitted to:\\\textit{Monthly Notices of the Royal Astronomical Society}]{}
\clearpage
