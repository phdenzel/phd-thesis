...
galaxy can be measured by the (Doppler) shift, i.e. redshift, of its spectral
lines.}.  Half a decade afterwards, Edwin Hubble investigated the relation
...
highly cited, Hubble's publication interestingly counts only 73 offical
...
measuring distances\sidenote{As explained below, gravitational waves changed the
game in more than one way.}.  Just like lighthouses acted as distance markers
...
\chref{delays} presents a critical analysis of such a measurement.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\par\noindent\rule{\textwidth}{0.8pt}

Light signals weaken with the square of their distance as described by
...
waves\sidenote{a highly non-classical effect!}.  A major advantage over their
