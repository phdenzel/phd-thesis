...
in the Universe \sidecite{Conselice16}, however so far less than a thousand
...
often seen as proof\sidenote{Not the only proof, as explained in following
sections.} for invisible and non-luminous matter, commonly called \textit{dark
...
\chref{delays} and \chref*{fossil}, new techniques were developed to optimize
...
\section{The Hubble constant}\seclbl{hubble_constant}
\input{tex/exp_universe}

\section{Galaxies}\seclbl{galaxies}
\input{tex/solar_nbhood}

\section{Lens models}\seclbl{lens_models}
